...
//                attr.gravity = Gravity.BOTTOM;
    ...
    private void initView() {
        View view = View.inflate(mContext, R.layout.dailog_sex, null);
        ...
        view.findViewById(R.id.ll_nan).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mOnBtnClickListener!=null){
        ...
        view.findViewById(R.id.ll_nu).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mOnBtnClickListener!=null){
